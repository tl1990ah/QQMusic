...
- (void)viewDidLoad
{
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithImageName:@"concise_icon_search_normal" highImageName:@"concise_icon_search_highlight" target:nil action:nil];
